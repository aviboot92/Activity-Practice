...
// And we can call their interface implemented methods on both...
console.log('--------------------------------------------------------------------------------');
console.log('Calling Buddy the Dogs cuddle method'); 
console.log('--------------------------------------------------------------------------------');
buddy.cuddle();
console.log('\n');

console.log('--------------------------------------------------------------------------------');
console.log('Calling Priscilla the Cats cuddle method'); 
console.log('--------------------------------------------------------------------------------');
priscilla.cuddle();
console.log('\n');


// We can instantiate either as an Pet as well...
let snoopy: Pet = new Dog("Snoopy");
let tom: Pet = new Cat("Tom");

console.log('--------------------------------------------------------------------------------');
console.log('Calling Snoopy the Dogs cuddle method'); 
console.log('--------------------------------------------------------------------------------');
snoopy.cuddle();
console.log('\n');
